...
public class VendorResponseDto implements Serializable {
    ...
    /******************************************************************************************************************
     * Timestamp of latest persistence regarding the Vendor in the database. Mandatory field.
     *****************************************************************************************************************/
    @JsonFormat(pattern = "yyyy-MM-dd'T'HH:mm:ss.SSS")
     ...
     *
     * @param id A UUID representing a unique identifier for the Vendor. Mandatory field.
     * @param name A human-readable string representing a unique identifier for the Vendor. Mandatory field.
     * @param description human-readable longer elucidation of the Vendor.
     * @param creationDate Timestamp of first persistence regarding the Vendor in the database. Mandatory field.
     * @param latestUpdateDate Timestamp of latest persistence regarding the Vendor in the database. Mandatory field.
     *****************************************************************************************************************/
